...
class myClient(protocol.Protocol):
    def __init__(self):
        ...
        self.Cppon = "Cppon"
        if len(sys.argv) > 1:
            self.sender = sys.argv[1]   # one of self.Mocap, self.Cppon, self.Impact.  Mocap is most performant
        else:
            print("Use 'Cppon', 'Mocap' or 'Impact' as a first parameter after the name of the python program")
